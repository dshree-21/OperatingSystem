...
_process4:     file format elf32-i386
...
int main(int argc, char **argv)
{
  ...
  1e:	e8 7d 04 00 00       	call   4a0 <printf>
	int i, a[2]={0};
    printf(1, "parent:%d %d\n", getpid(),getppid());
  23:	e8 ab 03 00 00       	call   3d3 <getppid>
  28:	89 c6                	mov    %eax,%esi
  2a:	e8 84 03 00 00       	call   3b3 <getpid>
  2f:	56                   	push   %esi
  30:	50                   	push   %eax
  31:	68 24 08 00 00       	push   $0x824
  36:	6a 01                	push   $0x1
  38:	e8 63 04 00 00       	call   4a0 <printf>
    	for(i=0;i<2;i++)
    	{
    	 	a[i]=fork();
  3d:	83 c4 20             	add    $0x20,%esp
  40:	e8 e6 02 00 00       	call   32b <fork>
    		if(a[i]==0)
  45:	85 c0                	test   %eax,%eax
  47:	74 69                	je     b2 <main+0xb2>
  49:	89 c6                	mov    %eax,%esi
    		...
    		{	
    		printf(1,"child:%d  %d\n",a[i],getpid());
  4b:	e8 63 03 00 00       	call   3b3 <getpid>
  50:	50                   	push   %eax
  51:	56                   	push   %esi
  52:	68 32 08 00 00       	push   $0x832
  57:	6a 01                	push   $0x1
  59:	e8 42 04 00 00       	call   4a0 <printf>
    			wait();
  5e:	e8 d8 02 00 00       	call   33b <wait>
    	 	a[i]=fork();
  63:	e8 c3 02 00 00       	call   32b <fork>
    		if(a[i]==0)
  ...
  6f:	74 43                	je     b4 <main+0xb4>
    		printf(1,"child:%d  %d\n",a[i],getpid());
  71:	e8 3d 03 00 00       	call   3b3 <getpid>
  76:	50                   	push   %eax
  77:	53                   	push   %ebx
  78:	68 32 08 00 00       	push   $0x832
  7d:	6a 01                	push   $0x1
  ...
  8f:	53                   	push   %ebx
  90:	e8 4e 03 00 00       	call   3e3 <waitpid>
  95:	89 c3                	mov    %eax,%ebx
    	printf(1,"WAIT:%d %d\n",c,getpid());
  97:	e8 17 03 00 00       	call   3b3 <getpid>
  9c:	50                   	push   %eax
  9d:	53                   	push   %ebx
  9e:	68 40 08 00 00       	push   $0x840
  a3:	6a 01                	push   $0x1
  ...
  b7:	6a 3c                	push   $0x3c
  b9:	e8 05 03 00 00       	call   3c3 <sleep>
    		    break;
  be:	83 c4 10             	add    $0x10,%esp
  c1:	eb c9                	jmp    8c <main+0x8c>
  c3:	66 90                	xchg   %ax,%ax
  c5:	66 90                	xchg   %ax,%ax
  c7:	66 90                	xchg   %ax,%ax
  c9:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	eb 1a                	jmp    640 <printf+0x1a0>
          s = "(null)";
 626:	bb 4c 08 00 00       	mov    $0x84c,%ebx
        while(*s != 0){
