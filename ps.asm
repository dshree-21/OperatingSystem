...
int main(int argc,char **argv)
{
  ...
  12:	83 ec 04             	sub    $0x4,%esp
   ...
   sps();
  15:	e8 21 03 00 00       	call   33b <sps>
 ...
 35c:	89 d1                	mov    %edx,%ecx
{
 ...
 389:	0f b6 92 8c 07 00 00 	movzbl 0x78c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 584:	eb 1a                	jmp    5a0 <printf+0x1a0>
          s = "(null)";
 586:	bb 84 07 00 00       	mov    $0x784,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d5:	a1 34 0a 00 00       	mov    0xa34,%eax
{
 ...
 5f6:	73 10                	jae    608 <free+0x38>
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	a3 34 0a 00 00       	mov    %eax,0xa34
}
 627:	5e                   	pop    %esi
 628:	5f                   	pop    %edi
 629:	5d                   	pop    %ebp
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 34 0a 00 00       	mov    %eax,0xa34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 66d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 670:	8b 3d 34 0a 00 00    	mov    0xa34,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6b9:	8b 3d 34 0a 00 00    	mov    0xa34,%edi
 ...
 6e2:	e8 e9 fe ff ff       	call   5d0 <free>
  return freep;
 6e7:	a1 34 0a 00 00       	mov    0xa34,%eax
 ...
 714:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 717:	a3 34 0a 00 00       	mov    %eax,0xa34
}
 ...
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf 38 0a 00 00       	mov    $0xa38,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 38 0a 00 00 38 	movl   $0xa38,0xa38
 746:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 74b:	c7 05 3c 0a 00 00 00 	movl   $0x0,0xa3c
 752:	00 00 00 
    if(p->s.size >= nunits){
